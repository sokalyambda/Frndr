...
// default 0.0. This is the minimum distance between the upper and lower values
...
@property (assign, nonatomic) CGFloat lowerHandleHiddenWidth;
@property (assign, nonatomic) CGFloat upperHandleHiddenWidth;
